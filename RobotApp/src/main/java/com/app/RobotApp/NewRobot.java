...
public class NewRobot implements Cloneable{
	...
	private NewRobotPartWithDonor newRobotPartWithDonor;
	...
	public NewRobotPartWithDonor getNewRobotPartWithDonor() {
		return newRobotPartWithDonor;
	}
	public void setNewRobotPartWithDonor(NewRobotPartWithDonor newRobotPartWithDonor) {
		this.newRobotPartWithDonor = newRobotPartWithDonor;
	}

	@Override
	public String toString() {
		return "NewRobot [model=" + model + ", serialNumber=" + serialNumber + ", brain=" + brain + ", vision=" + vision
				+ ", mobility=" + mobility + ", arms=" + arms + ", media_center=" + media_center + ", power_plant="
				+ power_plant + ", newRobotPartWithDonor=" + newRobotPartWithDonor + "]";
	}
